...
def hello():
    ...
    if request.method == 'POST':
        to_number=replace_zero(request.form['number'])
        message=request.form['text']

   
    if form.validate():
        # Save the comment here.
        flash('Sent ' + message + ' to: ' + to_number)
        send_msg(to_number, message)
